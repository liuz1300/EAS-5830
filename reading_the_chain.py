...
# https://eth-mainnet.g.alchemy.com/v2/TNlOyVZgDJrMtkRns3V88
# infura_url = f"https://mainnet.infura.io/v3/{infura_token}"

def connect_to_eth():
	# TODO insert your code for this method from last week's assignment
	url = "https://eth-mainnet.g.alchemy.com/v2/TNlOyVZgDJrMtkRns3V88"  # FILL THIS IN
...
def connect_with_middleware(contract_json):
	...
	url = "https://bnb-testnet.g.alchemy.com/v2/TNlOyVZgDJrMtkRns3V88"  # FILL THIS IN
	w3 = Web3(HTTPProvider(url))
...
def is_ordered_block(w3, block_num):
	...
	# Extract priority fees (maxPriorityFeePerGas) for each tx
