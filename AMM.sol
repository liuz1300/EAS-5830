...
contract AMM is AccessControl{
	...
	*/
	...
	function tradeTokens(address sellToken, uint256 sellAmount) public {
        ...
        // Apply fee: amountInWithFee = sellAmount * (10000 - feebps) / 10000
        ...
        // Update invariant
        uint256 new_invariant = ERC20(tokenA).balanceOf(address(this)) *
	...
	*/
	...
	function withdrawLiquidity( address recipient, uint256 amtA, uint256 amtB ) public onlyRole(LP_ROLE) {
		...
		require(
            ERC20(tokenA).balanceOf(address(this)) >= amtA &&
            ERC20(tokenB).balanceOf(address(this)) >= amtB,
